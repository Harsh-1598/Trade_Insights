...
# Dataset load karo
order_history = pd.read_excel(r'Datasets\Stocks_Order_History_With_Sectors_Yahoo.xlsx')
...
# 4. Save updated file
order_history.to_excel('Order_History_Split_DateTime.xlsx', index=False)

print("Execution Date & Time alag ho gaya! Check 'Order_History_Split_DateTime.xlsx'")