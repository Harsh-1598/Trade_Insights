      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-heading text-3xl font-bold tracking-tight md:text-4xl">
            <GradientText gradient="1">Market Overview</GradientText>
          </h1>
            ...
            <CardContent className="p-6">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-baseline gap-2">
                  <AnimatedValue value={index.value} prefix="₹" className="font-heading text-2xl font-bold" />
                  <span className={`font-medium ${index.trend === "up" ? "text-green-500" : "text-red-500"}`}>
                    {index.change > 0 ? "+" : ""}
                    {index.change} ({index.percentChange > 0 ? "+" : ""}
                    {index.percentChange}%)
                  </span>
                </div>
              </div>
